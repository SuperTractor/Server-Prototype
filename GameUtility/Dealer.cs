...
namespace GameUtility
{
    ...
    public class Dealer
    {
        ...
        void SortCards(List<Card> cards, int mode)
        {
        ...
        public void SortCards(List<Card> cards, int playerId, GameStateMachine.State state)
        {
            List<Card> temp = new List<Card>();
            // 先找大王
